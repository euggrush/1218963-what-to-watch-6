        ...
        <form onSubmit={handleSubmit} action="#" className="add-review__form">
          <div className="rating">
            <div className="rating__stars">
              ...
              <input onChange={handleFieldChange} className="rating__input" id="star-3" type="radio" name="rating" value="3" checked />
              ...
              <input onChange={handleFieldChange} className="rating__input" id="star-8" type="radio" name="rating" value="8" checked />
